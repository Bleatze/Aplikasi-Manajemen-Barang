...
@section('content')
    ...
    <div class=" p-4 mb-6 space-y-4 md:flex md:items-end md:space-x-4 md:space-y-0">
        ...
        <div id="modal-tambah-kategori" onclick="handleBackdropClick(event)" class="fixed inset-0 bg-transparent backdrop-blur-sm hidden justify-center items-center z-50">
            <!-- Modal box -->
