<aside class="w-64 bg-white shadow h-screen p-6 space-y-4 hidden md:block text-gray-700">
    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 hover:text-primary">
        <img src="https://api.iconify.design/mdi/view-dashboard.svg" alt="Dashboard" class="w-5 h-5">
        Dashboard
    </a>

    <a href="{{ route('users.index') }}" class="flex items-center gap-2 hover:text-primary">
    ...
    <a href="{{ route('kategori.index') }}" class="flex items-center gap-2 hover:text-primary">
        <img src="https://api.iconify.design/mdi:shape-outline.svg" alt="Kategori" class="w-5 h-5">
        Kategori
    </a>

    <a href="{{ route('satuan.index') }}" class="flex items-center gap-2 hover:text-primary">
        <img src="https://api.iconify.design/mdi:scale-balance.svg" alt="Satuan" class="w-5 h-5">
        Satuan
    </a>

    <a href="{{ route('barang.index') }}" class="flex items-center gap-2 hover:text-primary">
    ...
    <a href="{{ route('barang-masuk.index') }}" class="flex items-center gap-2 hover:text-primary">
        <img src="	https://api.iconify.design/mdi:tray-arrow-down.svg" alt="Barang Masuk" class="w-5 h-5">
        Barang Masuk
    </a>

    <a href="{{ route('barang-keluar.index') }}" class="flex items-center gap-2 hover:text-primary">
    ...
    <a href="{{ route('laporan.index') }}" class="flex items-center gap-2 hover:text-primary">
