...
>
    ...
    <a href="{{ route('dashboard') }}"
       title="Dashboard"
       class="group flex items-center gap-2 p-2 rounded transition-transform duration-200 hover:scale-105 hover:bg-purple-600
       {{ request()->routeIs('dashboard') ? 'bg-purple-500 text-white shadow-inner ring-2 ring-purple-300' : '' }}">
        <img src="https://api.iconify.design/lucide/layout-dashboard.svg?color=white" alt="Dashboard"
             class="w-5 h-5 transform transition-transform duration-200 group-hover:scale-125">
    ...
    <a href="{{ route('users.index') }}"
       ...
       {{ request()->routeIs('users.*') ? 'bg-purple-500 text-white shadow-inner ring-2 ring-purple-300' : '' }}">
        <img src="https://api.iconify.design/lucide/users.svg?color=white" alt="Users"
             class="w-5 h-5 transform transition-transform duration-200 group-hover:scale-125">
    ...
    @foreach ([['kategori.index', 'lucide/shapes', 'Kategori'],
              ['satuan.index', 'lucide/scale', 'Satuan'],
              ['barang.index', 'lucide/package', 'Barang']] as [$route, $icon, $label])
        <a href="{{ route($route) }}"
           title="{{ $label }}"
           class="group flex items-center gap-2 p-2 rounded transition-transform duration-200 hover:scale-105 hover:bg-purple-600
           {{ request()->routeIs(Str::before($route, '.') . '.*') ? 'bg-purple-500 text-white shadow-inner ring-2 ring-purple-300' : '' }}">
            <img src="https://api.iconify.design/{{ $icon }}.svg?color=white" alt="{{ $label }}"
                 class="w-5 h-5 transform transition-transform duration-200 group-hover:scale-125">
    ...
    <a href="{{ route('barang-masuk.index') }}"
       ...
       {{ request()->routeIs('barang-masuk.*') ? 'bg-purple-500 text-white shadow-inner ring-2 ring-purple-300' : '' }}">
        <img src="https://api.iconify.design/lucide/download.svg?color=white" alt="Barang Masuk"
             class="w-5 h-5 transform transition-transform duration-200 group-hover:scale-125">
    ...
    <a href="{{ route('barang-keluar.index') }}"
       ...
       {{ request()->routeIs('barang-keluar.*') ? 'bg-purple-500 text-white shadow-inner ring-2 ring-purple-300' : '' }}">
        <img src="https://api.iconify.design/lucide/upload.svg?color=white" alt="Barang Keluar"
             class="w-5 h-5 transform transition-transform duration-200 group-hover:scale-125">
    ...
    <a href="{{ route('laporan.index') }}"
       ...
       {{ request()->routeIs('laporan.*') ? 'bg-purple-500 text-white shadow-inner ring-2 ring-purple-300' : '' }}">
        <img src="https://api.iconify.design/lucide/file-bar-chart.svg?color=white" alt="Laporan"
             class="w-5 h-5 transform transition-transform duration-200 group-hover:scale-125">
